...
class TestEnte():
    ...
    def test_addMedico(self):
        with app.app_context():
            ...
            result = EnteService.creaReparto("RepartoCardiologia","ospedaleBergamo23Cardiologia@gmail.com","Papa230122","Cardiologia","Bergamo","ospedaleBergamo23@pec.it")
            oracle = True
    ...
    def test_addMedicoInvalid(self):
        with app.app_context():
            ...
            result = EnteService.creaReparto("RepartoCardiologia", "ospedaleBergamo23Cardiologia@gmail.com",
                                                     "Papa230122", "Cardiologia", "Bergamo", "ospedaleBergamo23")
            oracle = False
            assert oracle == result
