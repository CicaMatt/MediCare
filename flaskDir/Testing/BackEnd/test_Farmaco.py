...
class TestFarmaco:
    ...
    def test_filtrocatalogofarmacinoprezzo(self, client):
    ...
    def test_filtrocatalogofarmacinoprezzocategoriainvalid(self, client):
        sciroppo = Farmaco(prezzo=2.50, nome="Tachipirina", descrizione="Sciroppo", immagine="sciroppo.jpg",
                       categoria="Sciroppo")
        with app.app_context():
            db.session.add(sciroppo)
    ...
    def test_filtrocatalogonocat(self, client):
...
# inserisco prezzo non valido e non inserisco la categoria
    def test_filtrocatalogonocatprezzoinvalid(self, client):
    ...
    def test_filtrocatalogonoprezzonocategoria(self, client):
    ...
    def test_filtrocatalogoprezzoecategoria(self, client):
        oki = Farmaco(prezzo=5, nome="OkiTask", descrizione="OkiTask", immagine="Oki.jpg", categoria="Orosolubile")
        with app.test_request_context():
            with app.app_context():
                db.session.add(oki)
